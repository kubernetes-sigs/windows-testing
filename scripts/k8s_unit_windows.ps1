...
$SkipTestsForPackage = @{
    ...
    "./pkg/kubelet/..." = @(
        ...
        "TestAllocatedResourcesMatchStatus/burstable:_below_min_cpu_request",
        "TestAllocatedResourcesMatchStatus/burstable:_below_min_cpu_request_for_sidecar_containers",
        "TestAllocatedResourcesMatchStatus/burstable:_below_min_cpu_limit",
        "TestAllocatedResourcesMatchStatus/burstable:_below_min_cpu_limit_for_sidecar_containers",
        "TestGRPCMethods/v1alpha4",
        "TestKubeletServerCertificateFromFiles/remove_and_create",
        ...
        "TestMemoryPressure",
        "TestPIDPressure/eviction_due_to_pid_pressure"
    )
    "./pkg/scheduler/..." = @(
