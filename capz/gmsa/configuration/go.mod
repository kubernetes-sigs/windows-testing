module github.com/kubernetes-sigs/windows-testing/capz/gmsa/configuration
...
require (
	...
	sigs.k8s.io/cluster-api-provider-azure v1.3.1-0.20220630111009-a9ad6fb1c031
	sigs.k8s.io/cluster-api/test v1.1.4
	sigs.k8s.io/controller-runtime v0.11.2
)

require (
	github.com/Azure/aad-pod-identity v1.8.6 // indirect
