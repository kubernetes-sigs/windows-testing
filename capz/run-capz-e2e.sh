...
main() {
    ...
    export CAPI_EXTENSION_SOURCE="${CAPI_EXTENSION_SOURCE:-"https://github.com/jsturtevant/azure-capi-cli-extension/releases/download/pr-196/capi-0.1.5-py2.py3-none-any.whl"}"
